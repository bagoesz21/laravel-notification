...
class NotificationRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $deliveryRules = [
            'status' => ['required', 'integer', Rule::enum(DeliveryTimeStatus::class)],
    ...
    public function attributes()
    {
        ...
        $userCriteriaAttrs = Helper::appendArrayKey(
        ...
        $attrs = array_merge(
            $attrs,
            Helper::appendArrayKey($notifAttrs, 'notif'),
            Helper::appendArrayKey($userAttrs, 'users'),
            Helper::appendArrayKey($userCriteriaAttrs, 'users'),
            $channelAttrs,
            Helper::appendArrayKey($deliveryAttrs, 'delivery'),
